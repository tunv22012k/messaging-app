...
export default function BottomNav() {
    ...
    const navItems = [
        {
            name: 'Bản đồ', href: APP_ROUTES.map.index, icon: (
        ...
        {
            name: 'Lịch đặt', href: APP_ROUTES.bookings.myBookings, icon: (
                <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        {
            name: 'Nhượng sân', href: APP_ROUTES.marketplace, icon: (
                <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        {
            name: 'Tin nhắn', href: APP_ROUTES.chat.index, icon: (
                <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        {
            name: 'Cộng đồng', href: APP_ROUTES.people, icon: (
                <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
